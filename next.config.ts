...
// ye upr hide kiya sb niche update kiya h
import type { NextConfig } from "next";
...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      // ✅ Your live backend image sources
      {
        protocol: 'https',
        hostname: 'backendparadise-backend.glwcvg.easypanel.host',
        port: '',
      ...
      {
        protocol: 'https',
        hostname: 'backendparadise-backend.robn8s.easypanel.host',
        port: '',
        pathname: '/uploads/**',
      },
      {
        protocol: 'https',
        hostname: 'backendparadise-backend.easypanel.host',
        port: '',
        pathname: '/uploads/**',
      },
