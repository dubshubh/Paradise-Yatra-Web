...
//                   </motion.div>
//                 ) : (
//                   // ✅ No UI changes — same beautiful design
//                   <form onSubmit={handleSubmit} className="space-y-3">
//                     {/* Name */}
//                     <div>
//                       <label className="block text-xs font-medium bg-white text-gray-700 mb-0.5">
...
//                           } !bg-white !text-gray-700 focus:!bg-white focus:!text-gray-700`}
//                           placeholder="Enter your email address"
//                           disabled={isSubmitting}
//                         />
//                       </div>
...
export default function LeadCaptureForm({
  ...
  // ✅ Core submission function with strong error handling
  async function submitForm(formData: FormData) {
    try {
      ...
      if (!response.ok) {
        let errorMessage = "Failed to submit form due to server error.";
        try {
  ...
  // ✅ Main handler with user feedback
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    {[
                      {
                        ...
                        label: "Full Name *",
                        type: "text",
                        icon: <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />,
                        placeholder: "Enter your full name",
                      },
                      {
                        id: "email",
                        label: "Email Address *",
                        type: "email",
                        icon: <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />,
                      ...
                      },
                      {
                        ...
                        label: "Phone Number *",
                        type: "tel",
                        icon: <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />,
                        placeholder: "Enter your phone number",
                      },
                      {
                        id: "destination",
                        label: "Destination *",
                        type: "text",
                        icon: <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />,
                      ...
                      },
                      {
                        ...
                        label: "Budget *",
                        type: "text",
                        icon: <p className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">₹</p>,
                        placeholder: "Enter your budget (e.g., ₹50,000)",
                      },
                    ].map((field) => (
                      <div key={field.id}>
                    ...
                    <div className="flex items-start space-x-1.5">
                      ...
                      <label
                        ...
                        className="text-xs text-gray-700 leading-tight"
                      >
                        I would like to receive travel updates and offers
                      </label>
                    </div>
